...
window.onload = function init() {
    ...
    // var modelViewMat = lookAt(vec3(2.0 * Math.sin(0.0 * Math.PI / 180.0), 2.0 * Math.sin(0.0 * Math.PI / 180.0), 2.0 * Math.cos(0.0 * Math.PI / 180.0)), vec3(0.0, 0.0, 0.0), vec3(0.0, 1.0, 0.0));
